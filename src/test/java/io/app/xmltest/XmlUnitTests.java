...
public class XmlUnitTests {
    ...
    public void test_empty() {
        final String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><whatever xmlns:h=\"http://www.w3" +
                ".org/TR/html4/\" a=\"1\"></whatever>";
    ...
    @Test
    public void test_ns() {
        final String xml = "<foo:definitions xmlns:xsd='http://www.w3.org/2001/XMLSchema' " +
                "xmlns:foo='http://schemas.xmlsoap.org/wsdl/'></foo:definitions>";
        assertThat(xml, hasXPath("/node()"));
        // TODO: wildcard prefixing (according to: https://www.marklogic.com/blog/namespace-wildcards-in-xpath/)
